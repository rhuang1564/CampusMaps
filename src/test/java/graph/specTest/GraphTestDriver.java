...
public class GraphTestDriver {
    ...
    private final Map<String, DirectedGraph<String, DataEdge<String,String>>> graphs = new HashMap<>();
    ...
    private void addNode(String graphName, String nodeName) {
        ...
        DirectedGraph<String, DataEdge<String,String>> graph = graphs.get(graphName);
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        ArrayList<DataEdge<String,String>> edges = new ArrayList<>(graph.getOutEdges(parentName));
        edges.sort(Comparator.comparing(DataEdge<String,String>::getDestination).thenComparing(DataEdge::getData));
        for(DataEdge<String,String> curr : edges){
            output.print(" " + curr.getDestination() + "(" + curr.getData() + ")");
        }
        output.println();
    }
